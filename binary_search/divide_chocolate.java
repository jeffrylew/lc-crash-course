...
public int maximizeSweetnessSA(int[] sweetness, int k)
{
    // Second attempt solution based off the discussion solution more closely
    // matches binarySearch() in binary_search_templates.java
